...
public class LibraryEventProducer {
    ...
    public SendResult<Integer, String> sendLibraryEventSynchronous(LibraryEvent libraryEvent)
        ...
        try {
            ...
            log.error("Exception sending the message and the exception is: {}",
                    e.getMessage());
            e.printStackTrace();
            throw e;
        }
    ...
    private void handleFailure(Integer key, String value, Throwable ex) {
        ...
        try {
            ...
            log.error("Error in handleFailure: {}", ex.getMessage());
        }
    }

    private void handleSuccess(Integer key, String value, SendResult<Integer, String> result) {
        log.info("Message sent successfully for key: {} and the value is {}, partition is {}",
